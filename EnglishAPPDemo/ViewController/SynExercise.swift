...
class SynExercise: UIViewController {
    ...
    var scrollView :UIScrollView = {
        let scrollView = UIScrollView(frame: CGRect(x: 0, y: 172*Y_, width: SCREEN_WIDTH, height: SCREEN_HEIGHT-172*Y_))
        scrollView.contentSize = CGSize(width: SCREEN_WIDTH, height: 1100*Y_)
        return scrollView
    }()
    ...
    var selectBtn:UIButton = {
        let selectBtn = UIButton(frame: CGRect(x: 50*X_, y:129*Y_ , width: 315*X_, height: 34*Y_))
...
//        if sender.index(after: 0) == bg_wordListening{
//            let wordUnitChooseVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "WordUnitChooseController") as? WordUnitChooseController
//
//            wordUnitChooseVC?.headTitle = "单词听写"; self.navigationController!.pushViewController(wordUnitChooseVC!, animated: true)
//        }
...
//        let wordUnitChooseVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "WordUnitChooseController")
//        self.navigationController!.pushViewController(wordUnitChooseVC, animated: true)
    }
