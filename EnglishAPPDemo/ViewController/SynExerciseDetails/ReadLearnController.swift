...
class ReadLearnController: UIViewController {
    var key = " "
    override func viewDidLoad() {
        super.viewDidLoad()
        self.view.backgroundColor = UIColor.white
        let bg_HeadView = HeadBgView(frame: CGRect(x: 0, y: 0, width: SCREEN_WIDTH, height: 71*Y_), headLableFrame: CGRect(x: 119*X_, y: 35*Y_, width: 176*X_, height: 23*Y_), withTitle: "常用短语")
        ...
        detailView.detailtextField.text = "poor Man! 可怜的人"
        detailView.detailtextField.sizeToFit()
