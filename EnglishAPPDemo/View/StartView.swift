...
class StarView: UIView {
    ...
    open func drawStar(level: Int, count:Int){
        ...
        for i in 0...maxStars - 1 {
            ...
            let color = i < level ? UIColor(hexString: "#FFF04E") : UIColor.clear
 ...
 //           shapeLayer.strokeColor = UIColor(hexString:"#C7C9EB").cgColor
//            shapeLayer.borderWidth = 0.5
//            shapeLayer.borderColor = UIColor(hexString:"#C7C9EB").cgColor
